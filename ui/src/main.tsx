      ...
      <main>
        ...
        <div className="work-grid">
          <section className="input-panel" aria-label="Drawing upload and settings">
            ...
            <p className="field-help">{legacyRuntime ? 'Legacy body mode defaults to mm when the drawing omits units. This runtime does not run Revision B completeness checks.' : 'Revision B requires explicit units. Missing or conflicting units stop for review. Selecting a different unit proposes a correction; it does not override the sheet.'}</p>
